"""
Django settings for thateeguy project.
...
WSGI_APPLICATION = 'thateeguy.wsgi.application'
...
#AUTH URLS
LOGIN_REDIRECT_URL = 'index'    #valid view function
